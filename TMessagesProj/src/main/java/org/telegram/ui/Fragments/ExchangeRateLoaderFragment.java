 ...
 */
public final class ExchangeRateLoaderFragment extends CursorLoader implements SharedPreferences.OnSharedPreferenceChangeListener {
    private final Configuration config;

    public ExchangeRateLoaderFragment(final Context context, final Configuration config) {
