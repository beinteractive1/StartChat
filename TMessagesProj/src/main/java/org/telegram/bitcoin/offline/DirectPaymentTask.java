...
package org.telegram.bitcoin.offline;
...
public abstract class DirectPaymentTask
{
	...
	public final static class HttpPaymentTask extends DirectPaymentTask
	{
		...
		public HttpPaymentTask(@Nonnull final Handler backgroundHandler, @Nonnull final DirectPaymentTask.ResultCallback resultCallback, @Nonnull final String url,
			...
			super.backgroundHandler.post(new Runnable()
			{
				...
				public void run()
				{
					...
					try
					{
						...
						connection.setConnectTimeout(TimeoutConstants.HTTP_TIMEOUT_MS.timeout());
						connection.setReadTimeout(TimeoutConstants.HTTP_TIMEOUT_MS.timeout());
	...
	public final static class BluetoothPaymentTask extends DirectPaymentTask
	{
		...
		public BluetoothPaymentTask(@Nonnull final Handler backgroundHandler, @Nonnull final DirectPaymentTask.ResultCallback resultCallback,
