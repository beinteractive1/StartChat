package org.telegram.bitcoin.data;
...
public final class PaymentIntent implements Parcelable
{
    ...
    public final static class Output implements Parcelable
    {
        ...
        public String toString()
        {
            ...
            if (script.isSentToAddress() || script.isPayToScriptHash())
                builder.append(script.getToAddress(Network.NETWORK_PARAMETERS));
    ...
    {
        return new PaymentIntent(new Address(Network.NETWORK_PARAMETERS, address), addressLabel);
    }
    ...
    {
        final Transaction transaction = new Transaction(Network.NETWORK_PARAMETERS);
