package org.telegram.bitcoin.providers;
...
import org.telegram.ui.RequestCoinsActivity;
import org.telegram.ui.Send.SendCoinsActivity;
import org.telegram.ui.Send.SendCoinsQrActivity;
import org.telegram.ui.WalletActivity;
import org.telegram.utils.GenericUtils;
import org.telegram.utils.MonetarySpannable;
...
public class WalletBalanceWidgetProvider extends AppWidgetProvider
{
    ...
    {
        final ApplicationLoader application = (ApplicationLoader) context.getApplicationContext();
                                     ...
                                     final Bundle appWidgetOptions, final Coin balance)
    {
        ...
        if (data != null)
        {
            if (data.moveToFirst())
            {
                ...
                final MonetaryFormat localFormat = Formats.LOCAL_FORMAT.code(0,
                        Formats.PREFIX_ALMOST_EQUAL_TO + GenericUtils.currencySymbol(exchangeRate.getCurrencyCode()));
