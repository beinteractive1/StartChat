...
import org.telegram.bitcoin.constants.CurrencyConstants;
...
public class ExchangeRatesProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        this.userAgent = ApplicationLoader.httpUserAgent(ApplicationLoader.packageInfoFromContext(context).versionName);
    ...
    private ExchangeRate bestExchangeRate(final String currencyCode) {
        ...
        return exchangeRates.get(CurrencyConstants.DEFAULT_EXCHANGE_CURRENCY);
    }
