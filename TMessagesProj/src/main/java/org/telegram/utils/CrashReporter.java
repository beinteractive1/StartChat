...
public class CrashReporter
{
    ...
    public static void appendApplicationInfo(@Nonnull final Appendable report, @Nonnull final ApplicationLoader application) throws IOException
    {
        final PackageInfo pi = application.packageInfo();
        final Configuration configuration = application.getBitCoinConfig();
        final long now = System.currentTimeMillis();

        report.append("Version: " + pi.versionName + " (" + pi.versionCode + ")\n");
        report.append("Package: " + pi.packageName + "\n");
        report.append("Test/Prod: " + (Network.TEST ? "test" : "prod") + "\n");
        ...
        report.append("Network: " + Network.NETWORK_PARAMETERS.getId() + "\n");
